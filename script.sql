...
INSERT INTO users (id, name, email, password, delivery_address, delivery_number, delivery_district, delivery_city, role) VALUES
    ('1', 'Tryber Admin', 'tryber@trybe.com.br', '123456', 'Bandeirantes','97','Morumbi','São Paulo','administrator'),
    ('2', 'testuser', 'user@test.com', 'test123','Bandeirantes','97','Morumbi','São Paulo', 'client');
